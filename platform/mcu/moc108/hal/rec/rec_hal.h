...
#define DIFF_BACKUP_OFFSET 0xD6000
#define DIFF_CONF2_OFFSET  0xE7000
...
typedef struct
{
    ...
    uint8_t ota_flash_status[SPLISE_NUM];  // 每1byte代表64k的状态，0表示空闲，1表示占用，2表示已拷贝数据，3表示已从主区同步TODO: 个数需要改成宏定义
